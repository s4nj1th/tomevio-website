...
export default function SearchPage() {
  ...
  const renderResults = () => {
    if (loading) {
      return <p className="text-[var(--foreground-muted)] text-center">Searching...</p>;
    }
      ...
      return (
        <section className="mb-10">
          {books.length > 0 ? (
            ...
            <p className="text-[var(--foreground-dim)]">No books found.</p>
          )}
        </section>
      );
    }
        ...
        <section>
          <ul className="space-y-3">
            {authors.length > 0 ? (
              ...
              <p className="text-[var(--foreground-dim)]">No authors found.</p>
            )}
          </ul>
        </section>
      );
